...
import { useClientStats } from "@/hooks/useDashboardData";
...
const CATEGORY_TINTS: Record<string, string> = {
  ...
  role: "from-sky-500 to-teal-500",
  pdks: "from-emerald-500 to-teal-500",
  payroll: "from-teal-500 to-emerald-500",
  system: "from-cyan-500 to-teal-500",
  request: "from-sky-500 to-teal-500",
};
...
export default function ClientDashboard() {
  ...
  const { data, loading } = useClientStats();
  ...
  const kpis: Kpi[] = data
    ? [
        ...
        },
        {
          ...
          value: formatNumber(data.monthlyAttendance),
          delta: "Aylık giriş sayısı",
          deltaPositive: true,
        ...
        },
        {
          label: "Bu Ay Ciro",
          value: "—",
          delta: "Faturalama modülü yakında",
          deltaPositive: true,
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
            Çalışan aktiviteleri ve operasyonel özet.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                    Çalışan hareketleri ve sistem bildirimleri
                  </p>
                </div>
                <a
                  href="#!"
